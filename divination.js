...
const meaningsData = [
    ...
    { id: 16, title: "The Charioteer", char: "Livewire", duality: "Change", path: "Progression", color: "#1663ce", img: "images/Livewire.jpg", guidance: "Move quickly! Sudden, shocking shifts are coming your way today. Ride the momentum." },
    { id: 17, title: "The Ruler", char: "Medusa", duality: "Totality", path: "Progression", color: "#ea0c86", img: "images/Medusa.png", guidance: "You must carry the weight of leadership today. Take absolute responsibility for your domain." },
    ...
    // THE DIRECTION
    { id: 25, title: "The Infant", char: "Singularity", duality: "Void", path: "Direction", color: "#165df5", img: "images/Singularity.jpg", guidance: "You are entering a space where the rules have not been written. Embrace the terrifying, infinite potential." },
    { id: 26, title: "The Deceased", char: "Hela", duality: "Malice", path: "Direction", color: "#00c597", img: "images/Hela.jpg", guidance: "Accept the harsh truth that something must end today. Let it wither. Enforce your boundaries strictly." },
    ...
    { id: 32, title: "The Gravedigger", char: "Selene Gallio", duality: "Lack", path: "Direction", color: "#f41e5b", img: "images/Selene.jpg", guidance: "You may feel a deep hunger or sense of scarcity today. Do not indulge in dark thoughts." },
    ...
    { id: 36, title: "The Drowning", char: "Silver Banshee", duality: "Negative", path: "Direction", color: "#c1e0ff", img: "images/Silver-Banshee.jpg", guidance: "Unresolved grief or frustration may try to surface today. Express the pain, but do not become it." },
